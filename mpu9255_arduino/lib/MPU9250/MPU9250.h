...
public:
    ...
    void printRawData() const
    {
        ...
        Serial.print(";"); Serial.print((int)1000 * a[1]);
        Serial.print(";"); Serial.print((int)1000 * a[2]); //mg
        // Print gyro values in degree/sec
        Serial.print(";"); Serial.print(g[0], 2);
        Serial.print(";"); Serial.print(g[1], 2);
        Serial.print(";"); Serial.print(g[2], 2); //deg/s
        // Print mag values in degree/sec
        Serial.print(";"); Serial.print((int)m[0]);
        Serial.print(";"); Serial.print((int)m[1]);
        Serial.print(";"); Serial.print((int)m[2]); //mG

        Serial.print(";"); Serial.print(q[0]);
